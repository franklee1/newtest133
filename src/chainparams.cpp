...
CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount &genesisReward) {
    const char *pszTimestamp = "New time new node, it's UNODE 2018";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1516945034, 79382, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock ==
               uint256S("0x00000d9ee4691f814fc90c61f8db2c2f4228680b25355e9bde2059f9fe527646"));
        assert(genesis.hashMerkleRoot ==
               uint256S("0xc51d947a01fdb209c8532acaaf3cab4f0e9f552b72ae293ea440af41262a9273"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("45.77.78.72", "45.77.78.72"));
